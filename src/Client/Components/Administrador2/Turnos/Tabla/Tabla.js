...
class TablaTurnos extends Component {
    render() {
        ...
        return(
                ...
                <table id="TABLA" className="table table-sm table-dark">
                    <thead>
                        <tr>
                            <th scope="col"><a href=""><i className="fas fa-caret-left"></i></a></th>
                            <th scope="col">Lunes 6</th>
                            <th scope="col">Martes 7</th>
                            <th scope="col">Miercoles 8</th>
                            <th scope="col">Jueves 9</th>
                            <th scope="col">Viernes 10</th>
                            <th scope="col"><a href=""><i className="fas fa-caret-right"></i></a></th> 
                            <th scope="col"><a href=""><i className="fas fa-angle-double-right"></i></a></th> 
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
