            ...
            <div className="row" id="odontograma-UWU">
                    ...
                    <div className="card">
                        <div className="card-body" id="Arriba">
                            <div className="row ml-4 mt-1">
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE" ><img className="ml-2" src={props.PiezaSeleccionada == "Pieza18" ? `/images/odontograma/NumerosSeleccionados/18.png` : "/images/odontograma/Numeros/18.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE" ><img className="ml-2" src={props.PiezaSeleccionada == "Pieza17" ? `/images/odontograma/NumerosSeleccionados/17.png` : "/images/odontograma/Numeros/17.png"} alt="" /></a>  
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE" ><img className="ml-2" src={props.PiezaSeleccionada == "Pieza16" ? `/images/odontograma/NumerosSeleccionados/16.png` : "/images/odontograma/Numeros/16.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE" ><img className="ml-2" src={props.PiezaSeleccionada == "Pieza15" ? `/images/odontograma/NumerosSeleccionados/15.png` : "/images/odontograma/Numeros/15.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE" ><img className="ml-2" src={props.PiezaSeleccionada == "Pieza14" ? `/images/odontograma/NumerosSeleccionados/14.png` : "/images/odontograma/Numeros/14.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE" ><img className="ml-2" src={props.PiezaSeleccionada == "Pieza13" ? `/images/odontograma/NumerosSeleccionados/13.png` : "/images/odontograma/Numeros/13.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE" ><img className="ml-2" src={props.PiezaSeleccionada == "Pieza12" ? `/images/odontograma/NumerosSeleccionados/12.png` : "/images/odontograma/Numeros/12.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE" ><img className="ml-2" src={props.PiezaSeleccionada == "Pieza11" ? `/images/odontograma/NumerosSeleccionados/11.png` : "/images/odontograma/Numeros/11.png"} alt="" /></a>
                            </div>
                ...
                <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body" id="Arriba">
                            <div className="row ml-4 mt-1">
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza21" ? `/images/odontograma/NumerosSeleccionados/21.png` : "/images/odontograma/Numeros/21.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza22" ? `/images/odontograma/NumerosSeleccionados/22.png` : "/images/odontograma/Numeros/22.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza23" ? `/images/odontograma/NumerosSeleccionados/23.png` : "/images/odontograma/Numeros/23.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza24" ? `/images/odontograma/NumerosSeleccionados/24.png` : "/images/odontograma/Numeros/24.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza25" ? `/images/odontograma/NumerosSeleccionados/25.png` : "/images/odontograma/Numeros/25.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza26" ? `/images/odontograma/NumerosSeleccionados/26.png` : "/images/odontograma/Numeros/26.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza27" ? `/images/odontograma/NumerosSeleccionados/27.png` : "/images/odontograma/Numeros/27.png"} alt="" /></a>
                                <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza28" ? `/images/odontograma/NumerosSeleccionados/28.png` : "/images/odontograma/Numeros/28.png"} alt="" /></a>
                            </div>                        
                            <div className="row ml-4">
                ...
                <div className="row" id="odontograma-UWU">
                    <div className="col-sm-6">
                        <div className="card">
                            <div className="card-body" id="Arriba">
                                <div className="row ml-4 mt-1">
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza48" ? `/images/odontograma/NumerosSeleccionados/48.png` : "/images/odontograma/Numeros/48.png"}  alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza47" ? `/images/odontograma/NumerosSeleccionados/47.png` : "/images/odontograma/Numeros/47.png"}  alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza46" ? `/images/odontograma/NumerosSeleccionados/46.png` : "/images/odontograma/Numeros/46.png"}  alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza45" ? `/images/odontograma/NumerosSeleccionados/45.png` : "/images/odontograma/Numeros/45.png"}  alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza44" ? `/images/odontograma/NumerosSeleccionados/44.png` : "/images/odontograma/Numeros/44.png"}  alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza43" ? `/images/odontograma/NumerosSeleccionados/43.png` : "/images/odontograma/Numeros/43.png"}  alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza42" ? `/images/odontograma/NumerosSeleccionados/42.png` : "/images/odontograma/Numeros/42.png"}  alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza41" ? `/images/odontograma/NumerosSeleccionados/41.png` : "/images/odontograma/Numeros/41.png"}  alt="" /></a>
                                </div>
                                <div className="row ml-4">
                    ...
                    <div className="col-sm-6">
                        <div className="card">
                            <div className="card-body" id="Arriba">
                                <div className="row ml-4 mt-1">
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza31" ? `/images/odontograma/NumerosSeleccionados/31.png` : "/images/odontograma/Numeros/31.png"} alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza32" ? `/images/odontograma/NumerosSeleccionados/32.png` : "/images/odontograma/Numeros/32.png"} alt="" /></a>  
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza33" ? `/images/odontograma/NumerosSeleccionados/33.png` : "/images/odontograma/Numeros/33.png"} alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza34" ? `/images/odontograma/NumerosSeleccionados/34.png` : "/images/odontograma/Numeros/34.png"} alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza35" ? `/images/odontograma/NumerosSeleccionados/35.png` : "/images/odontograma/Numeros/35.png"} alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza36" ? `/images/odontograma/NumerosSeleccionados/36.png` : "/images/odontograma/Numeros/36.png"} alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza37" ? `/images/odontograma/NumerosSeleccionados/37.png` : "/images/odontograma/Numeros/37.png"} alt="" /></a>
                                    <a href="" data-toggle="modal" data-target="#HISTORIALDIENTE"><img className="ml-2" src={props.PiezaSeleccionada == "Pieza38" ? `/images/odontograma/NumerosSeleccionados/38.png` : "/images/odontograma/Numeros/38.png"} alt="" /></a>
                                </div>
                                <div className="row ml-4">
